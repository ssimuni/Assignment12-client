                    ...
                    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div class="grid lg:grid-cols-2 grid-cols-1">
                            <div class="lg:mb-0 mb-10">
                                <div class="group w-full lg:h-2/3">
                                    <div class="relative h-full">
                                        <img src="stat1.jpg" alt="ContactUs tailwind section" class="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-indigo-700" />
                            ...
                            <div class="lg:h-2/3 p-5 lg:p-6  shadow-lg">
                                <h2 class="text-[#E3963E] font-manrope text-4xl font-semibold leading-10 mb-11">Add your article</h2>

                                <div className="relative mt-5">
                                    <input id="title" name="title" type="text" className="peer placeholder-transparent h-10 w-full border-b-2 pl-5 rounded border-[#E3963E]  focus:outline-none focus:borer-rose-600" placeholder="Image URL" />
                                ...
                                <div class="mt-5">
                                    ...
                                    <div>
                                        <input id="photobutton" type="file" class="block w-full cursor-pointer appearance-none rounded-l-md border-b-2 rounded border-[#E3963E]  bg-white px-3 py-2 text-sm transition focus:z-10 focus:border-[#E3963E] focus:outline-none focus:ring-1 focus:ring-[#E3963E] disabled:cursor-not-allowed disabled:bg-gray-200 disabled:opacity-75" />
                                    ...
                                    <div class="flex">
                                        <div class="flex items-center mr-11">
                                            ...
                                            <label for="radio-group-1" class="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                                                <span class="border border-[#E3963E] rounded-full mr-2 w-4 h-4  ml-2 "></span> Email
                                            </label>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <label for="radio-group-2" class="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                                                <span class="border border-[#E3963E]  rounded-full mr-2 w-4 h-4  ml-2 "></span> Phone
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <input type="text" class="w-full h-12 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 rounded-full border border-[#E3963E] focus:outline-none pl-4 mb-10" placeholder="Message" />
                                <button class="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-orange-500 bg-[#E3963E] shadow-sm">Send</button>
