...
const AllArticlesAdminTable = ({ article }) => {
    ...
    const handleDelete = _id => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(import.meta.env.VITE_API_URL + `/All-Articles/${_id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
    ...
    const handleApprove = _id => {
        fetch(import.meta.env.VITE_API_URL + `/All-Articles/approve/${_id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handlePremium = _id => {
        fetch(import.meta.env.VITE_API_URL + `/All-Articles/isPremium/${_id}`, {
            method: 'PATCH'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleDecline = _id => {
        Swal.fire({
            ...
            preConfirm: (reason) => {
                return fetch(import.meta.env.VITE_API_URL + `/All-Articles/decline/${_id}`, {
                    method: 'PATCH',
                    headers: {
