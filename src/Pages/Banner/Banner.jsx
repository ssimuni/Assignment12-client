    ...
    return (
        <div>
            <div class="max-w-screen-xl flex items-center justify-center mt-10">
                ...
                >
                    <SwiperSlide>
                        <img src="1.png" className='h-[300px] ' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="2.png" className='h-[300px] ' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="3.png" className='h-[300px] ' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="4.png" className='h-[300px] ' />
                    </SwiperSlide>
                    <SwiperSlide>
                        <img src="5.png" className='h-[300px] ' />
                    </SwiperSlide>
